...
static const struct es9p_error es9p_errors[] = {
    ...
    {"8.1.1", "2.2",
     "Indicates that the EID is missing in the context of this order (SM-DS address provided or MatchingID value is "
     "empty)"},
    ...
    {"8.2.5", "3.8",
     "Indicates that the Profile Type identified by this Profile Type is not aligned with the Profile Type of Profile "
