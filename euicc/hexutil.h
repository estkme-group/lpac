...
int euicc_hexutil_gsmbcd2bin(uint8_t *output, uint32_t output_len, const char *input, uint32_t padding_to);

int euicc_hexutil_bin2gsmbcd(char *output, uint32_t output_len, const uint8_t *bin, uint32_t bin_len);
