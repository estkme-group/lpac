...
static const struct applet_entry *applets[] = {
    ...
    &(struct applet_entry){.name = "enable", .main = applet_profile_operation_main},
    &(struct applet_entry){.name = "disable", .main = applet_profile_operation_main},
    &(struct applet_entry){.name = "delete", .main = applet_profile_operation_main},
