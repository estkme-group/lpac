...
* `LPAC_APDU_UQMI_DEVICE`: specify which uQMI device will be used by uQMI APDU backend.
* `LPAC_APDU_UQMI_SLOT`: specify which UIM slot will be used by uQMI APDU backend. (default: 1, slot number starts from 1)
